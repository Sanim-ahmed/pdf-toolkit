...
export default function WordToPdfPage() {
  ...
  const addFile = useCallback(
    (newFiles: FileList | File[]) => {
      const docx = Array.from(newFiles).find((f) =>
  ...
  const handleConvert = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch("https://pdf-toolkit-backend-tma2.onrender.com/api/pdf/from-word", {
        method: "POST",
        body: formData,
      });
      ...
      setError(e instanceof Error ? e.message : "Failed to convert Word");
    } finally {
        ...
        <section className="relative overflow-hidden px-6 pb-24 pt-28 md:pt-36">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-lg text-slate-400">
              Transform Word documents into universally compatible PDF files instantly.
            </p>
          </div>
          ...
          <div className="mx-auto mt-12 max-w-2xl">
            ...
            >
              ...
              <p className="text-base font-medium text-white">
                {isDragging ? "Drop your DOCX here" : "Drag & drop a DOCX file here"}
              </p>
              ...
              <p className="mt-1 text-xs text-slate-600">
                Supports DOCX files up to 50 MB
              </p>
            </div>
