        ...
        <section className="relative overflow-hidden px-6 pb-24 pt-28 md:pt-36">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl">
              OCR
              <br />
              <span className="gradient-text">Text Extraction</span>
            </h1>
          ...
          <div className="mx-auto mt-12 max-w-2xl">
            <div
              ...
              className={`relative cursor-pointer rounded-2xl border-2 border-dashed p-10 text-center transition-all duration-300 ${
                isDragging
                  ? "border-amber-500 bg-amber-500/[0.08] scale-[1.02] shadow-2xl shadow-amber-500/10"
                  : "border-white/10 bg-white/[0.02] hover:border-amber-500/40 hover:bg-amber-500/[0.04]"
              }`}
            >
              <input
                ref={inputRef}
              ...
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-amber-500/10">
                <svg
                  className={`h-8 w-8 transition-colors ${
                    isDragging ? "text-amber-400" : "text-amber-500/60"
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <p className="mt-1 text-xs text-slate-600">
                Supports PDF, PNG, JPG, WEBP, BMP, TIFF &mdash; up to 100 MB
              </p>
            </div>
              ...
              <div className="mt-6">
                  ...
                  <div className="mt-5 rounded-xl border border-amber-500/20 bg-amber-500/[0.04] p-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <p className="text-sm font-medium text-white">{stats.pagesProcessed}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-500">Characters Extracted</p>
                        <p className="text-sm font-medium text-white">{stats.charsExtracted.toLocaleString()}</p>
                      </div>
                      <div>
                ...
                {downloadUrl ? (
                  <button
                    ...
                    className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-amber-600 to-orange-600 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-amber-500/25 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-amber-500/30"
                  >
                    <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
