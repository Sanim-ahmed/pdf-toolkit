          ...
          <div className="mx-auto mt-12 max-w-2xl">
            <div
              ...
              className={`relative cursor-pointer rounded-2xl border-2 border-dashed p-10 text-center transition-all duration-300 ${
                isDragging
                  ? "border-pink-500 bg-pink-500/[0.08] scale-[1.02] shadow-2xl shadow-pink-500/10"
                  : "border-white/10 bg-white/[0.02] hover:border-pink-500/40 hover:bg-pink-500/[0.04]"
              }`}
            >
              <input
                ref={inputRef}
              ...
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-pink-500/10">
                <svg
                  className={`h-8 w-8 transition-colors ${
                    isDragging ? "text-pink-400" : "text-pink-500/60"
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <p className="mt-2 text-sm text-slate-500">
                or{" "}
                <span className="text-pink-400 underline underline-offset-2">
                  browse files
                </span>
              </p>
              ...
              <div className="mt-6">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-1.5 text-xs text-slate-500">
                    Specify pages to extract (e.g. 1-3, 5, 2,4,7-9)
                  </p>
                </div>
