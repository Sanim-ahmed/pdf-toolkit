        ...
        <section className="relative overflow-hidden px-6 pb-24 pt-28 md:pt-36">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-lg text-slate-400">
              Convert multiple images into a single PDF document. Each image becomes one page.
            </p>
          </div>
          ...
          <div className="mx-auto mt-12 max-w-2xl">
            <div
              ...
              className={`relative cursor-pointer rounded-2xl border-2 border-dashed p-10 text-center transition-all duration-300 ${
                isDragging
                  ? "border-teal-500 bg-teal-500/[0.08] scale-[1.02] shadow-2xl shadow-teal-500/10"
                  : "border-white/10 bg-white/[0.02] hover:border-teal-500/40 hover:bg-teal-500/[0.04]"
              }`}
            >
              <input
                ref={inputRef}
              ...
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-teal-500/10">
                <svg
                  className={`h-8 w-8 transition-colors ${
                    isDragging ? "text-teal-400" : "text-teal-500/60"
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <p className="mt-1 text-xs text-slate-600">
                PNG, JPG, JPEG, WEBP, BMP &mdash; up to {MAX_IMAGES} images, 100 MB total
              </p>
            </div>
                ...
                <ul className="space-y-2" role="list">
                  {files.map((f, i) => (
                    <li
                      ...
                      className={`glass-card flex items-center gap-4 rounded-xl px-4 py-3 transition-all duration-200 ${
                        overIdx === i && dragIdx !== i
                  ...
                  <div className="mt-5 rounded-xl border border-teal-500/20 bg-teal-500/[0.04] p-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <p className="text-sm font-medium text-white">{stats.imageCount}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-500">Pages</p>
                        <p className="text-sm font-medium text-white">{stats.pageCount}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <p className="text-xs text-slate-500">Output PDF</p>
